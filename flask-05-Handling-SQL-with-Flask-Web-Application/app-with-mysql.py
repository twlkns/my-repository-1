...
mysql = MySQL()
#next two lines to init and connect to DB
mysql.init_app(app)
connection = mysql.connect()
#so you don't have to commit after each add or update
...
VALUES 
    ...
    ("busra","busra@google");
"""
#Execute sql commands and commit them - create table and add users into DB
