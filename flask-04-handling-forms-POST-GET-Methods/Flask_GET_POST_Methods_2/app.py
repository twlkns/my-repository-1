...
def calculate():
    if request.method == "POST":
        ...
        return render_template("result.html", var1=num1, var2=num2, result=lcm(int(num1),int(num2)), developer_name="Tony")
    else:
        return render_template("result.html", developer_name="Tony")
